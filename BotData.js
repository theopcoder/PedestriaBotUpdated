...
var Errors = [
    Error6 = "**:warning: Error 6:** ```Invalid description or argument detected! Try making sure the command is being performed correctly and try again!```",
    ...
    StaffUser = ":no_entry_sign: Sorry, you cannot perform this command on a staff member!",
